...
static const char __pyx_k_home_hj_ZX_DL_DL_OCR_ChineseAdd[] = "/home/hj/ZX_DL/DL_OCR/ChineseAddress_OCR-master/ctpn/lib/utils/gpu_nms.pyx";
 ...
 */
  ...
  __pyx_codeobj__12 = (PyObject*)__Pyx_PyCode_New(3, 0, 10, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__11, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_hj_ZX_DL_DL_OCR_ChineseAdd, __pyx_n_s_gpu_nms, 16, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__12)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
